...
class Part1(unittest.TestCase):
    ...
    def setUpClass(self):
        ...
        self.input_imgs_1 = ['test_lk3.png']
        self.input_imgs_2 = ['test_lk4.png']
    ...
    def test_optic_flow_LK(self):
        ...
        for i in range(1):
            ...
            error_msg = "Average of U values in the area where there is " \
                        "movement is greater than the allowed amount." + " actual :" + str(abs(u_mean - d_c))
            ...
            error_msg = "Average of V values in the area where there is " \
                        "movement is greater than the allowed amount." + " actual :" + str(abs(v_mean - d_r))
...
class Part4(unittest.TestCase):
    ...
    def test_optic_flow_HLK(self):
        ...
        for i in range(3):
            ...
            error_msg = "Average of U values in the area where there is " \
                        "movement is greater than the allowed amount. u_mean: " + str(u_mean - d_c) + ", max_diff: " + str(max_diff)
